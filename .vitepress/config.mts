      ...
      "/book/": [
        {
          ...
          items: [
            ...
            },
            {
              text: "Chapter 7",
              link: "/book/chapter7",
              items: [{ text: "Chapter 7.1", link: "/book/chapter7.1" }],
            },
            {
              text: "Chapter 8",
              link: "/book/chapter8",
              items: [
                { text: "Chapter 8.1", link: "/book/chapter8.1" },
                { text: "Chapter 8.2", link: "/book/chapter8.2" },
              ],
            },
          ],
        },
          ...
          items: [
            ...
            { text: "Install", link: "/docs/install/" },
            {
              ...
              items: [
                ...
                { text: "try", link: "/docs/keywords/try" },
                { text: "catch", link: "/docs/keywords/catch" },
